...
def plot_longetivity_liv_scenario(year, liv_exp_list):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('retirement scenario report/graphs/lng_liv_expenses_plot.png')
...
def plot_longetivity_health_scenario(year, health_exp_list):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('retirement scenario report/graphs/lng_health_expenses_plot.png')
...
def plot_longetivity_misc_scenario(year, misc_exp_list):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('retirement scenario report/graphs/lng_misc_expenses_plot.png')
