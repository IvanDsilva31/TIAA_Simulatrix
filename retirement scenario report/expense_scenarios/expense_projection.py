...
def plot_living_expense(year, liv_exp_list):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('retirement scenario report\graphs\living_expenses_plot.png')
...
def plot_health_expense(year, health_exp_list):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('retirement scenario report/graphs/health_expenses_plot.png')
...
def plot_misc_expense(year, misc_exp_list):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('retirement scenario report\graphs\misc_expenses_plot.png')
