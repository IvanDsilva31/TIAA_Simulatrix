...
def create_pdf(name,  age, retirement_age, life_span, savings, income, liv_exp, health_exp, misc_exp):
    pdf_filename = "retirement scenario report/output_report.pdf"
    ...
    liv_exp_img = 'retirement scenario report/graphs/living_expenses_plot.png' 
    health_exp_img = 'retirement scenario report/graphs/health_expenses_plot.png'
    misc_exp_img = 'retirement scenario report/graphs/misc_expenses_plot.png'
    lng_liv_exp_img = 'retirement scenario report/graphs/lng_liv_expenses_plot.png'
    lng_health_exp_img = 'retirement scenario report/graphs/lng_health_expenses_plot.png'
    lng_misc_exp_img = 'retirement scenario report/graphs/lng_misc_expenses_plot.png' 
...
exp.expense_projector("John Philips", 54, 60, 80, 500000,1200000, 300000, 500000, 300000)
create_pdf("John Philips", 54, 60, 80, 500000,1200000, 300000, 500000, 300000)
